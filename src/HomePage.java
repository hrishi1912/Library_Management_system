...
public class HomePage extends JFrame implements ActionListener {
    ...
    public HomePage() {
        ...
        JMenuItem Student_info = new JMenuItem("Student Details");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/addbook.gif"));
        Image i2 = i1.getImage().getScaledInstance(150, 145, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        l2 = new JLabel(i3);
        l2.setBounds(60, 140, 152, 145);
        contentPane.add(l2);
        ...
        l3 = new JLabel(i6);
        l3.setBounds(345, 140, 225, 168);
        contentPane.add(l3);

        JLabel l4 = new JLabel("");
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/addstudents.png"));
        Image i8 = i7.getImage().getScaledInstance(150, 150, Image.SCALE_DEFAULT);
        ImageIcon i9 = new ImageIcon(i8);
        l4 = new JLabel(i9);
        l4.setBounds(678, 140, 225, 152);
        contentPane.add(l4);
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icons/bookissue.gif"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/return boook.png"));
        Image i14 = i13.getImage().getScaledInstance(150, 150, Image.SCALE_DEFAULT);
        ImageIcon i15 = new ImageIcon(i14);
        l6 = new JLabel(i15);
        l6.setBounds(538, 440, 137, 152);
        contentPane.add(l6);
